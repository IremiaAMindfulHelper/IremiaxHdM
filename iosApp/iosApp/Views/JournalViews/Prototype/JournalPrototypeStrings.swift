...
struct JournalPrototypeStringProxy {
    private let values: [String: String] = [
        ...
        "garden_reset": "Garten zurücksetzen",
        "garden_reset_confirm_title": "Garten zurücksetzen?",
        "garden_reset_confirm_message": "Das entfernt alle gepflanzten Bäume und Blumen. Deine Einträge bleiben erhalten.",
        "garden_reset_confirm_action": "Zurücksetzen",
        "garden_reset_cancel": "Abbrechen",
        "episode_detail_title": "Episode",
        "episode_detail_edit": "Bearbeiten",
