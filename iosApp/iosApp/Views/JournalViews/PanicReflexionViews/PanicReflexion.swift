...
// Diese View zeigt die Panik-Reflexion für einen bestimmten Tag.
// Sie besteht aus vier aufklappbaren Kategorien mit Eingaben und Auswahl-Elementen.
// Unten gibt es einen Button zum Abschließen, oben eine Toolbar mit Zurück-Navigation.
// Zusätzlich wird der Tastatur-Fokus zentral verwaltet, damit sich die Tastatur per Tap schließen lässt.
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ForEach(vm.symptomOptions, id: \.self) { item in
                    SymptomRow(
                        title: item,
                        isSelected: vm.selectedSymptoms.contains(item)
                    ) {
